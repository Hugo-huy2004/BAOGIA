...
export const NOTIFICATION_TEXT = {
  vi: {
    ...
    "event.joyLaterStage.grace.title": "Khoản JOYlater đã tới hạn",
    "event.joyLaterStage.grace.message": "Khoản còn lại {{amount, joy}} đã quá hạn {{days}} ngày. Hoàn tất trong tuần này để tài khoản giữ nguyên mọi quyền.",
    "event.joyLaterStage.restricted.title": "Tài khoản tạm hạn chế",
    "event.joyLaterStage.restricted.message": "Do khoản JOYlater {{amount, joy}} quá hạn {{days}} ngày, quyền chuyển JOY và mở khoản mới tạm ngưng cho tới khi khoản nợ được hoàn tất.",
    "event.joyLaterStage.frozen.title": "Chi tiêu đã được đóng băng",
    "event.joyLaterStage.frozen.message": "Khoản JOYlater {{amount, joy}} đã quá hạn {{days}} ngày. Kể từ nay, JOY nhận được sẽ dành trọn cho việc hoàn khoản nợ.",
    "event.joyLaterStage.locked.title": "Tài khoản đã bị khoá có thời hạn",
