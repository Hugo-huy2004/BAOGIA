...
export const MEMBER_APP_TRANSLATIONS = {
  ...
  th: {
    ...
    catalog: catalog([
      ["vocab", "ภาษาจีน", "แฟลชการ์ดภาษาจีน HSK & TOCFL ทบทวนอัจฉริยะ"],
      ...
      ["invest", "การลงทุน", "ตลาดหุ้นจำลอง: เรียนลงทุนด้วย JOY ไม่ใช้เงินจริง"],
      ...
      ["supporter", "ศูนย์ช่วยเหลือ", "คู่มือสำเร็จรูปและส่งคำขอถึงผู้ดูแลระบบ"],
  ...
  ja: {
    ...
    catalog: catalog([
      ["vocab", "中国語", "HSK・TOCFL 中国語単語カード、賢い復習"],
  ...
  ko: {
    ...
    catalog: catalog([
      ["vocab", "중국어", "HSK·TOCFL 중국어 단어 카드, 스마트 복습"],
      ...
      ["invest", "투자", "가상 증권거래소: JOY로 투자 배우기, 실제 돈은 쓰지 않음"],
      ["info", "정보", "시스템 정보와 릴리스 노트"],
      ["joy_wallet", "JOY 지갑", "잔액과 빠른 JOY 송금"],
      ["store", "스토어", "앱, 토큰, 서비스 스토어"],
      ["supporter", "지원 센터", "준비된 안내와 관리자에게 보내는 요청"],
  ...
  id: {
    ...
    catalog: catalog([
      ["vocab", "Bahasa Mandarin", "Kartu kosakata Mandarin HSK & TOCFL dengan ulasan cerdas"],
      ...
      ["invest", "Investasi", "Bursa saham virtual: belajar investasi dengan JOY, tanpa uang asli"],
      ...
      ["supporter", "Pusat Bantuan", "Panduan siap pakai dan permintaan ke admin"],
  ...
  es: {
    ...
    catalog: catalog([
      ["vocab", "Chino", "Tarjetas de chino HSK y TOCFL con repaso inteligente"],
      ...
      ["invest", "Inversión", "Bolsa virtual: aprende a invertir con JOY, sin dinero real"],
      ...
      ["supporter", "Centro de Soporte", "Guías listas y solicitudes a un administrador"],
  ...
  fr: {
    ...
    catalog: catalog([
      ["vocab", "Chinois", "Cartes de chinois HSK et TOCFL avec révision intelligente"],
      ...
      ["invest", "Investir", "Bourse virtuelle : apprendre à investir avec des JOY, sans argent réel"],
      ...
      ["supporter", "Centre d'assistance", "Guides prêts à lire et demandes à un administrateur"],
