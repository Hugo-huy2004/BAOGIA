...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-background relative overflow-hidden pt-24 pb-20 transition-colors duration-300">
                ...
                <div 
                  ...
                  className={`group cursor-pointer rounded-2xl transition-all duration-300 overflow-hidden border ${
                    isExpanded 
                      ...
                      : "bg-white/60 dark:bg-transparent border-border/50 hover:border-slate-300 dark:hover:border-white/20 hover:bg-white dark:hover:bg-white/5"
                  }`}
                >
                  <div className="p-5 md:p-6 flex items-start gap-4 md:gap-5">
                    ...
                    <div className={`shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-xl flex items-center justify-center transition-all duration-500 ${
                      isExpanded 
                        ...
                        : "bg-slate-100 dark:bg-white/10 text-muted-foreground group-hover:scale-105"
                    }`}>
                    ...
                    <div className="flex-1 min-w-0 pt-0.5 md:pt-1">
                      <div className="flex justify-between items-start gap-4">
                        <h3 className={`text-base md:text-lg font-bold leading-tight transition-colors duration-300 ${
                          isExpanded ? "text-foreground" : "text-slate-700 dark:text-slate-200 group-hover:text-slate-900 dark:group-hover:text-white"
                        }`}>
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="space-y-3">
                  ...
                  <a 
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-700 dark:text-slate-300 font-bold transition-all border border-border/50"
                  >
