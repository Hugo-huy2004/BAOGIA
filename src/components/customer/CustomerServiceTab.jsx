...
export default function CustomerServiceTab({ project }) {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      {/* Handler Info */}
      <div className="bg-white dark:bg-[#12111a] rounded-3xl p-6 border border-slate-200 dark:border-slate-800/80 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
      ...
      {/* Progress Bar */}
      <div className="bg-white dark:bg-[#12111a] rounded-3xl p-6 md:p-8 border border-slate-200 dark:border-slate-800/80 shadow-sm relative overflow-hidden">
        {isCompleted && (
          <div className="absolute inset-0 bg-white/40 dark:bg-[#12111a]/60 backdrop-blur-[1px] z-10 pointer-events-none" />
        )}
      ...
      {isCompleted && project.finalNote && (
        <div className="bg-emerald-50 dark:bg-emerald-900/10 rounded-3xl p-6 md:p-8 border border-emerald-200 dark:border-emerald-800/50 shadow-sm relative z-20 animate-fadeInUp">
          ...
          <div className="text-sm text-emerald-800 dark:text-emerald-200/80 leading-relaxed bg-white/50 dark:bg-black/20 p-5 rounded-2xl">
            {renderFormattedNote(project.finalNote)}
          </div>
        </div>
      )}
    </div>
