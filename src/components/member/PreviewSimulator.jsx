  ...
  return (
    <div className="lg:col-span-5 lg:sticky lg:top-6 flex flex-col items-center space-y-3 sm:space-y-4 w-full">
      <div className="flex items-center gap-2 sm:gap-3 w-full justify-center sm:justify-start">
        <span className="text-[8px] sm:text-[10px] font-bold text-muted-foreground/70 uppercase tracking-widest">
          {t("memberPortal.preview.livePreview")}
        </span>
        <div className="flex bg-[#767680]/10 dark:bg-[#767680]/20 p-0.5 rounded-full border border-border/10 shadow-[inset_0_1px_1px_rgba(0,0,0,0.05)]">
          <button
            type="button"
            ...
            className={`px-2 sm:px-3 py-1 rounded-full text-[8px] sm:text-[9px] font-bold flex items-center gap-0.5 sm:gap-1 transition-all ${
              previewMode === "mobile"
                ? "bg-white dark:bg-[#636366] text-foreground shadow-sm"
                : "text-zinc-500"
            }`}
          >
        ...
        <div
          className={`${
            previewMode === "mobile"
              ...
              : "w-full h-[580px] sm:h-[610px] rounded-lg sm:rounded-xl border-2 sm:border-4 border-border bg-background dark:bg-zinc-950 shadow-2xl p-0.5 sm:p-1 relative flex flex-col justify-between"
          }`}
        >
          ...
          <div className="w-full h-full rounded-[1.8rem] sm:rounded-[2.3rem] overflow-hidden bg-white dark:bg-background relative flex flex-col border border-zinc-900/10 dark:border-zinc-800/10">
            ...
            <div className="bg-muted/50 border-b border-border/50 px-3 py-2 flex items-center justify-between text-[9px] text-muted-foreground select-none shrink-0">
              <div className="flex gap-1 shrink-0">
                <span className="w-1.5 h-1.5 rounded-full bg-destructive" />
                <span className="w-1.5 h-1.5 rounded-full bg-yellow-400" />
                <span className="w-1.5 h-1.5 rounded-full bg-success" />
              </div>
              <div className="bg-card px-2.5 py-0.5 rounded-full border border-border/40 truncate max-w-[150px] text-[8px] font-mono">
