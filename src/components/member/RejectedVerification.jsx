...
export default function RejectedVerification({ handleLogout }) {
  return (
    <div className="max-w-md mx-auto py-12 px-4 animate-fadeIn relative">
      <div className="bg-white/80 dark:bg-[#1c1c1e]/80 backdrop-blur-md border border-zinc-200/50 dark:border-zinc-800/60 p-8 rounded-3xl shadow-xl text-center space-y-6 relative overflow-hidden">
        ...
        <button
          ...
          className="w-full py-2.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl shadow-sm transition-all active:scale-95 text-xs flex justify-center items-center gap-1.5"
        >
