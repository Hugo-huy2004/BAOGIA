...
// getLessonReading sống riêng ở ./reading.js: hai màn hình chỉ cần bảng tra 24
// dòng này, mà import qua index.js kéo theo cả 6 tệp nội dung bài học (538 KB
// nguồn → chunk 556 KB) vào client. Re-export để chỗ cũ vẫn chạy.
export { getLessonReading } from "./reading.js";
