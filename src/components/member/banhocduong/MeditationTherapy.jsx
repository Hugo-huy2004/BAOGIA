  ...
  return (
    <div className="space-y-5 text-center max-w-md mx-auto animate-scaleUp">
      ...
      <div className="py-6 space-y-4">
        <div className="text-6xl font-mono font-black text-teal-500 animate-pulse">
        ...
        <div className="space-y-2 max-w-xs mx-auto">
          <label className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider block">Kênh Tĩnh Tâm (Web Audio Synth)</label>
        ...
        {/* Peaceful Visual Flower Breathing */}
        <div className="flex justify-center pt-2">
          <div className={`w-12 h-12 rounded-full bg-teal-500/20 border-2 border-teal-500/40 transition-all duration-3000 ${
            isTimerRunning ? "scale-[1.8] animate-pulse" : "scale-100"
          }`} />
        </div>
        
        <p className="text-[10px] text-zinc-400 italic max-w-xs mx-auto leading-relaxed font-semibold">
          "Hãy nhắm mắt, thẳng lưng, hít thở nhẹ nhàng tự nhiên và trút bỏ hoàn toàn mọi ý nghĩ đè nặng trong đầu..."
        </p>
      </div>
    </div>
  );
