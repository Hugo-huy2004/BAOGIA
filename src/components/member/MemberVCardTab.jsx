            ...
            {isMobile ? (
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900/40 p-5 rounded-2xl border border-zinc-200/40 dark:border-zinc-800/80 space-y-4">
                ...
                {syncing ? (
                  ...
                  /* Already synced: show status + small update button */
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-3 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/50 rounded-xl">
                      <span className="material-symbols-outlined text-emerald-500 text-xl">cloud_done</span>
                      <div className="flex-1 min-w-0">
                        <p className="text-[11px] font-black text-emerald-700 dark:text-emerald-400">
                          {t("memberPortal.utilitiesPage.vcard.syncedStatus", { count: contactsList.length }) || `Đã lưu ${contactsList.length} liên hệ trên Cloud`}
                        </p>
                        <p className="text-[9.5px] text-emerald-600/70 dark:text-emerald-500/70">
                          {t("memberPortal.utilitiesPage.vcard.syncedStatusDesc") || "Danh bạ đã được sao lưu. Nhấn Cập nhật để đồng bộ lại."}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 py-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-300 font-bold text-[10px] uppercase tracking-wider flex items-center justify-center gap-1.5 transition-all active:scale-95"
                      >
                        ...
                        {t("memberPortal.utilitiesPage.vcard.resyncGoogleBtn") || "Cập nhật Google"}
                      </button>
                      <button
                      ...
                      >
                        ...
                        {t("memberPortal.utilitiesPage.vcard.resyncBtn") || "Cập nhật"}
                      </button>
                      <button
                        onClick={() => setShowManualAdd(true)}
                        className="px-3 py-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700 text-zinc-500 font-bold text-[10px] flex items-center justify-center transition-all active:scale-95"
                        title={t("memberPortal.utilitiesPage.vcard.manualAddBtn") || "Thêm lẻ"}
                      >
                  ...
                  /* First time: show prominent sync buttons */
                ...
                <table className="w-full text-left border-collapse text-[11px]">
                  <thead>
                    <tr className="bg-zinc-100/50 dark:bg-zinc-800/50 border-b border-zinc-200 dark:border-zinc-800 text-[10px] text-zinc-400 uppercase font-black tracking-wider">
                      <th className="py-2.5 px-4">{t("memberPortal.utilitiesPage.vcard.colName") || "Tên"}</th>
                      <th className="py-2.5 px-4">{t("memberPortal.utilitiesPage.vcard.colPhone") || "Số điện thoại"}</th>
                      <th className="py-2.5 px-4 text-right">{t("memberPortal.utilitiesPage.vcard.colAction") || "Thao tác"}</th>
                    </tr>
                  </thead>
