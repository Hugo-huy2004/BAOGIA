          ...
          {(!formData.services || formData.services.length === 0) ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {formData.services.map((srv) => (
                <div key={srv.id} className="group relative flex items-center gap-3 p-3 bg-white dark:bg-[#181622] rounded-2xl border border-slate-200 dark:border-slate-800/80 shadow-sm">
