...
export default function PendingVerification({ fullName, handleLogout }) {
  return (
    <div className="max-w-md mx-auto py-12 px-4 animate-fadeIn">
      <div className="bg-white/80 dark:bg-[#1c1c1e]/80 backdrop-blur-md border border-zinc-200/50 dark:border-zinc-850/60 p-8 rounded-3xl shadow-xl text-center space-y-6 relative overflow-hidden">
        ...
        <div className="p-4 rounded-xl bg-amber-500/5 dark:bg-amber-950/10 border border-amber-500/10 text-[11px] text-amber-700 dark:text-amber-400 flex gap-2.5 text-left leading-relaxed">
        ...
        <button
          ...
          className="w-full py-2.5 border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 text-zinc-700 dark:text-zinc-300 text-xs font-bold rounded-xl transition-all active:scale-95"
        >
          Đăng xuất
        </button>
      </div>
