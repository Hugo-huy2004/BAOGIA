...
export default function VerificationForm({
  ...
  return (
    <div className="max-w-xl mx-auto py-8 px-4 animate-fadeIn">
      <div className="bg-white/80 dark:bg-[#1c1c1e]/80 backdrop-blur-md border border-zinc-200/50 dark:border-zinc-850/60 p-6 sm:p-8 rounded-3xl shadow-xl space-y-6 relative overflow-hidden">
        ...
        <form onSubmit={handleVerificationSubmit} className="space-y-5">
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-[#121214] text-xs text-zinc-800 dark:text-zinc-100 outline-none focus:ring-2 focus:ring-indigo-500 transition-all placeholder-zinc-400"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-[#121214] text-xs text-zinc-800 dark:text-zinc-100 outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
                />
              </div>
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex-1 py-2.5 border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 text-zinc-700 dark:text-zinc-300 text-xs font-bold rounded-xl transition-all active:scale-95"
            >
              Đăng xuất
            </button>
            <button
              type="submit"
              disabled={verifying}
              className="flex-[2] py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl transition-all active:scale-95 shadow-md shadow-indigo-200/40 dark:shadow-none flex justify-center items-center gap-1.5 disabled:opacity-50 disabled:pointer-events-none"
            >
              {verifying && (
