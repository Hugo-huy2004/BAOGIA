...
const GDPRCompliantBadge = () => {
  return (
    <div
      ...
      role="note"
      aria-label="Privacy posture and data-protection policy; this is not a certification"
    >
      <div className="flex items-center gap-0.5">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-indigo-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <span className="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Posture</span>
    </div>
  );
};
