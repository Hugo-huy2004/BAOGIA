...
const W3CBadge = () => {
  return (
    <a
      ...
      aria-label="Check the current markup with the W3C validator in a new tab"
    >
      ...
      <span className="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">W3C Check</span>
    </a>
  );
};
