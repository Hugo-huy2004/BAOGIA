...
const NortonSafeWebBadge = () => {
  return (
    <a
      ...
      aria-label="Check the current site status with Norton Safe Web in a new tab"
    >
      ...
      <span className="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Status Check</span>
    </a>
  );
};
