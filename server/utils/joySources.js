...
export const JOY_SOURCES = {
  ...
  ide_phase_1_completion: 'Hoàn thành chặng 1 HugoCoder',
  ide_phase_2_completion: 'Hoàn thành chặng 2 HugoCoder',
  ide_phase_3_completion: 'Hoàn thành chặng 3 HugoCoder',
...
export const JOY_SOURCE_GROUPS = {
  ...
  deco_story: 'choi',
  deco_daily: 'choi',
  deco_visit_sent: 'choi',
  deco_visit_received: 'choi',
  ide_learning: 'hoc',
  ...
  focus_session: 'hoc',
  community_post: 'congdong',
  community_comment: 'congdong',
  community_like_received: 'congdong',
  community_anon_post: 'congdong',
